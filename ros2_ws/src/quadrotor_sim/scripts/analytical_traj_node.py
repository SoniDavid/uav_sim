#!/usr/bin/env python3
"""Analytical trajectory generator for quadrotor_sim.

Publishes /uav/reference (12D) directly — bypasses reference_node so that
...
height      : float — z setpoint in metres                 (default: 1.0)
...
class AnalyticalTrajNode(Node):
    ...
    def __init__(self):
        super().__init__('uav_analytical_traj')
        ...
        self.pub_ref_pose = self.create_publisher(PoseStamped,       '/uav/reference/pose', 10)
